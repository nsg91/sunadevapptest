...
function ProfileScreen({ sky, onBack, onOpenSettings }) {
  ...
  // Tweakable: which state to render (hidden behind Tweaks panel)
  ...
  var [tweaksOn, setTweaksOn] = React.useState(false);

  // Listen for tweaks-panel toggle so the preview switcher is only shown in tweaks mode
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 12.5, fontWeight: 300, color: sky.sub, marginTop: 3, letterSpacing: '0.04em' }}>
      ...
      <div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
            <div style={{ fontSize: 15, fontWeight: 400, color: sky.txt }}>Day {baselineDay} of 7</div>
            <div style={{ fontSize: 12.5, fontWeight: 300, color: sky.sub, letterSpacing: '0.04em' }}>each morning sharpens it</div>
          </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 15, fontWeight: 400, color: sky.txt }}>You{'\u2019'}ve checked in this morning.</div>
        </div>

        {/* Why it matters — rotates per day */}
        <div style={{ marginTop: 28 }}>
          <SansEyebrow color={sky.sub} style={{ marginBottom: 10 }}>Why it matters</SansEyebrow>
          <p style={{ fontSize: 16, fontWeight: 300, fontStyle: 'italic', color: sky.txt,
        ...
        <div style={{ marginTop: 36 }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 12.5, fontWeight: 300, fontStyle: 'italic', color: sky.sub,
          ...
          {[
            ...
            return (
              <div key={i} style={{ display: 'flex', justifyContent: 'space-between',
                ...
                <span style={{ fontSize: 15, fontWeight: 300, color: sky.sub }}>{r.k}</span>
                <span style={{ fontSize: 15, fontWeight: 400, color: sky.txt }}>{r.v}</span>
              </div>
            );
          })}
        </div>
      ...
      <div>
        ...
        <div style={{ marginTop: 30 }}>
          ...
          <div style={{
            ...
            <p style={{ fontSize: 16, fontWeight: 300, color: sky.txt, lineHeight: 1.55,
        ...
        <div style={{ marginTop: 22 }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 14, fontWeight: 300, color: sky.sub, lineHeight: 1.45 }}>
      ...
      <div>
          ...
          {observations.map(function(obs, i) {
            return (
              <div key={i} style={{
                ...
                <p style={{ fontSize: 15, fontWeight: 300, color: sky.txt, lineHeight: 1.55,
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 4 }}>
            <span style={{ fontSize: 16, fontWeight: 400, color: sky.fp, letterSpacing: '-0.01em' }}>+31%</span>
          </div>
        </div>
          ...
          return (
            <div key={i} style={{
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: 12.5, fontWeight: 300, fontStyle: 'italic', color: sky.sub, marginTop: 3 }}>{p.note}</div>
              </div>
              <div style={{ fontSize: 12.5, fontWeight: 400, color: sky.sub, letterSpacing: '0.04em',
  ...
  return (
    <div className="vara-scroll" data-dc-passthrough style={{
      ...
      <div style={{ position: 'relative', padding: '60px 24px 120px' }}>
        ...
        {/* State switcher — Tweaks-mode only (hidden in production) */}
        {tweaksOn && (
        <div style={{ marginBottom: 28, padding: '12px 12px', borderRadius: 14,
          ...
          {profileState === 'baseline' && (
            <div style={{ marginTop: 10, display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div style={{ fontSize: 12.5, fontWeight: 500, color: sky.txt,
