  ...
  return (
    <div className="vara-scroll" data-dc-passthrough style={{
      ...
      <div style={{ position: 'relative', padding: '60px 24px 120px' }}>
        ...
        {isFirst && (
          <p style={{
            fontSize: 14, fontWeight: 300, fontStyle: 'italic', color: sky.sub,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{
                fontSize: 15, fontWeight: 500, letterSpacing: '0.14em',
        ...
        <div style={{
          ...
          <div style={{
            fontSize: 15, fontWeight: 300, color: sky.sub, fontStyle: 'italic',
          ...
          <button onClick={function() { onStartPractice(topPractice); }} style={{
            ...
            <div style={{ padding: '16px 18px' }}>
              ...
              <div style={{ fontSize: 12.5, fontWeight: 300, color: sky.sub, marginTop: 3 }}>{topPractice.subtitle}</div>
              <div style={{
                ...
                <span style={{
                  fontSize: 12.5, fontWeight: 500, letterSpacing: '0.12em',
                  textTransform: 'uppercase', color: stateInfo.color,
                }}>{voice.cta}</span>
                <span style={{ fontSize: 16, color: stateInfo.color }}>{'\u2192'}</span>
              </div>
            </div>
          </button>
          ...
          <button onClick={function() { onNavigate('library'); }} style={{
            ...
            fontSize: 14, fontWeight: 400, color: sky.sub, textAlign: 'center',
