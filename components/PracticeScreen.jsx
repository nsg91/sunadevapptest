...
function PracticeScreen({ sky, practice, onComplete, onCancel }) {
  ...
  var catLabel = practice.category === 'spark' ? 'Spark'
               : practice.category === 'flow'  ? 'Flow'
               : practice.category === 'play'  ? 'Play'
               : 'Anchor';
  var catColor = practice.category === 'spark' ? '#E8A572'
               : practice.category === 'flow'  ? '#7AC4B0'
               : practice.category === 'play'  ? '#C49696'
               : '#8A7EB0';
      ...
      <div style={{ position: 'relative', padding: '60px 24px 120px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div>
            ...
            <div style={{
              fontSize: 14, fontWeight: 300, color: sky.sub, marginTop: 4,
          ...
          <button onClick={onCancel} style={{
            ...
            fontSize: 16, color: sky.sub, marginTop: 4,
          }}>{'\u00D7'}</button>
        </div>

        {/* description */}
        <p style={{
          fontSize: 15, fontWeight: 300, color: sky.sub, lineHeight: 1.6,
            ...
            {(practice.instructions || []).map(function(inst, i) {
              ...
              return (
                <button key={i} onClick={function() { if (started) setStepIdx(i); }}
                  ...
                  {/* instruction text */}
                  <div style={{
                    fontSize: 15, fontWeight: isActive ? 400 : 300,
        ...
        <div style={{
          ...
          <p style={{ fontSize: 14, fontWeight: 300, color: sky.sub, lineHeight: 1.6, margin: '0 0 8px' }}>
            {practice.mars}
          </p>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 14, fontWeight: 300, color: sky.txt, lineHeight: 1.6, margin: 0 }}>
            {practice.perfFlex}
          </p>
        </div>
