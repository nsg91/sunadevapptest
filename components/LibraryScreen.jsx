  ...
  return (
    <div className="vara-scroll" data-dc-passthrough style={{
      ...
      <div style={{ position: 'relative', padding: '60px 24px 120px' }}>
        ...
        <div style={{
          fontSize: 15, fontWeight: 300, color: sky.sub, lineHeight: 1.5,
        ...
        <div style={{
          marginTop: 20, fontSize: 14, fontWeight: 300, fontStyle: 'italic',
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '16px 16px 14px' }}>
        ...
        <div style={{ fontSize: 12.5, fontWeight: 300, color: sky.sub, marginTop: 3 }}>{practice.subtitle}</div>
        <p style={{ fontSize: 14, fontWeight: 300, color: sky.sub, lineHeight: 1.6, margin: '10px 0 0' }}>{practice.description}</p>
        ...
        <button onClick={function() { setShowMars(!showMars); }} style={{
          ...
          fontSize: 11.5, fontWeight: 500, letterSpacing: '0.14em',
        ...
        {showMars && (
          <div style={{
            ...
            <div style={{ fontSize: 12.5, fontWeight: 400, color: sky.txt, marginBottom: 6 }}>{practice.perfFlex}</div>
            <div style={{ fontSize: 12.5, fontWeight: 300, color: sky.sub, fontStyle: 'italic', marginBottom: 6 }}>{practice.mars}</div>
