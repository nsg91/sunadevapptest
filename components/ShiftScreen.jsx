  ...
  return (
    <div className="vara-scroll" data-dc-passthrough style={{
      ...
      <div style={{ position: 'relative', padding: '60px 24px 120px' }}>
        ...
        <div style={{
          fontSize: 15, fontWeight: 300, color: sky.sub, marginTop: 8, lineHeight: 1.5,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              marginTop: 12, fontSize: 12.5, fontWeight: 500,
        ...
        <div style={{
          ...
          <p style={{
            fontSize: 15, fontWeight: 300, color: sky.txt, lineHeight: 1.65, margin: 0,
          }}>
            ...
            return (
              <div key={i}>
                <button onClick={function() { togglePill(i); }} style={{
                  ...
                  <div>
                    <div style={{ fontSize: 11.5, fontWeight: 500, letterSpacing: '0.18em', textTransform: 'uppercase', color: sky.sub }}>{p.label}</div>
                    <div style={{ fontSize: 20, fontWeight: 300, color: stateAfter.color, marginTop: 2, fontVariantNumeric: 'tabular-nums' }}>
                      {p.value} <span style={{ fontSize: 12.5, color: sky.sub, fontWeight: 400 }}>{p.unit}</span>
                    </div>
                  </div>
                  <span style={{
                ...
                {open && (
                  <div style={{
                    ...
                    <p style={{ fontSize: 14, fontWeight: 300, color: sky.sub, lineHeight: 1.6, margin: 0 }}>{p.detail}</p>
                  </div>
                )}
              </div>
            );
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              <button onClick={function() { onNavigate('library'); }} style={{
                ...
                fontSize: 12.5, fontWeight: 500, letterSpacing: '0.14em',
        ...
        <div style={{
          ...
          <button onClick={function() { setShareOpen(true); }} style={{
            ...
            fontFamily: 'var(--vara-sans)',
            fontSize: 12.5, fontWeight: 400, letterSpacing: '0.08em', color: sky.sub,
    ...
    <div onClick={onClose} style={{
      ...
      <div onClick={function(e) { e.stopPropagation(); }} style={{
        ...
        <div style={{
          ...
          fontSize: 11.5, fontWeight: 500, letterSpacing: '0.5em',
        ...
        <div style={{
          ...
          <div style={{
            ...
            fontFamily: 'var(--vara-sans)', fontSize: 16, fontWeight: 300,
          ...
          }}>{(REVEAL_VOICE && REVEAL_VOICE[stateAfter.state] && REVEAL_VOICE[stateAfter.state].insight) || 'Internal clearance achieved.'}</div>
        </div>
      ...
      <div style={{
        ...
        <button onClick={function() { /* save handler */ }} style={{
          ...
          fontFamily: 'var(--vara-sans)', fontSize: 12.5, fontWeight: 600,
      ...
      <div style={{
        marginTop: 12, fontFamily: 'var(--vara-sans)', fontSize: 12.5, fontWeight: 300,
